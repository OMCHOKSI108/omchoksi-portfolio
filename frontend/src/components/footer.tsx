    ...
    <footer className="relative bg-[var(--background)] text-[var(--foreground)] pt-20 pb-8 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute inset-0 opacity-[0.13] dark:opacity-[0.17]">
          ...
          <div
            className="absolute inset-0 bg-gradient-to-b from-[var(--background)] via-transparent to-transparent"
            style={{ height: "30%" }}
          />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          >
            FROM DATA TO <span className="opacity-50">INSIGHT</span>
          </motion.h2>
            ...
            >
              <svg viewBox="0 0 100 100" className="w-full h-full">
                ...
                <text className="text-[10px] font-bold uppercase fill-[var(--foreground)] tracking-[0.15em]">
                  <textPath href="#curve">
                    AIML student • Open to learn • AIML student • Open to learn •
                  </textPath>
                </text>
              </svg>
          ...
          <div className="text-center">
            <p className="text-lg md:text-xl font-medium mb-1">
              I'm available for <span className="text-blue-500">full-time roles</span> &
              {" "}
              <span className="text-purple-500">freelance projects</span>.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-[var(--border)] pt-16 pb-12">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-[var(--muted-foreground)] max-w-sm leading-relaxed">
              I'm Om · an AIML student and aspiring data & AI engineer. Thanks for checking out my site!
            </p>
          ...
          <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <h4 className="text-sm font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                General
              </h4>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <Link href="/bucket-list" className="hover:text-blue-500 transition-colors">
                    Bucket List
                  </Link>
                </li>
                <li>
                  <Link href="/uses" className="hover:text-blue-500 transition-colors">
                    Uses
                  </Link>
                </li>
                <li>
                  <Link href="/attribution" className="hover:text-blue-500 transition-colors">
                    Attribution
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <Link href="/links" className="hover:text-blue-500 transition-colors">
                    Links
                  </Link>
                </li>
                <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-[var(--border)] text-sm text-[var(--muted-foreground)]">
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex gap-4">
              <Link href="/privacy" className="hover:text-[var(--foreground)] transiton-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:text-[var(--foreground)] transiton-colors">
                Terms of Use
              </Link>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full hover:bg-[var(--muted)] hover:text-[var(--foreground)] transition-colors"
            >
            ...
            <div className="flex gap-2">
              <a
                ...
                target="_blank"
                className="p-2 rounded-full hover:bg-[var(--muted)] hover:text-[#0077b5] transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                className="p-2 rounded-full hover:bg-[var(--muted)] hover:text-[#1DA1F2] transition-colors"
              >
