      ...
      <div className="max-w-6xl mx-auto px-6 space-y-32">
        ...
        <div>
            ...
            <div className="text-center mb-20 space-y-4">
                <span className="text-xs font-bold tracking-[0.2em] text-[var(--muted-foreground)] uppercase">The Experience</span>
                <h2 className="text-4xl md:text-6xl font-serif-display leading-tight">
                    Experience That <br />
                    ...
                    {EXPERIENCE.map((exp, index) => (
                        <div key={index} className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
                            ...
                            <div className={`md:text-right space-y-2 ${index % 2 !== 0 ? "md:order-2 md:text-left" : ""}`}>
                                <span className="text-xs font-bold text-[var(--muted-foreground)] tracking-wider uppercase block mb-1">
                                    {exp.date}
                                </span>
