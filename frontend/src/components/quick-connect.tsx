  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end justify-center p-4">
      <div className="w-full max-w-lg mx-auto bg-[var(--card)]/95 backdrop-blur-xl p-6 rounded-[2rem] shadow-2xl font-sans text-[var(--foreground)] border border-[var(--border)] animate-in slide-in-from-bottom-4 duration-300">
        ...
        {/* --- Footer Status --- */}
        <div className="mt-6 bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded-xl py-3 px-4 flex items-center justify-center gap-2">
          <div className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
          </div>
          <span className="text-sm font-semibold text-green-700 dark:text-green-50">
