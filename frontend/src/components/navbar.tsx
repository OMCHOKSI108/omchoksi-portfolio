          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <div className="relative group">
              ...
              <div className={`absolute top-full right-0 mt-2 w-48 rounded-2xl backdrop-blur-3xl border shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform origin-top-right overflow-hidden z-50 ${theme === 'dark'
                ...
                <a href="https://drive.google.com/file/d/1TJjCk-HImfvgH-v8vygzeWan1mB8RGB-/view?usp=sharing" target="_blank" rel="noopener noreferrer" className={`block px-4 py-3 text-sm transition-colors ${theme === 'dark' ? 'text-zinc-300 hover:text-white hover:bg-white/5' : 'text-zinc-600 hover:text-black hover:bg-black/5'
                  }`}>
                  Resume
                </a>
              </div>
